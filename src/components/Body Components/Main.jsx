  ...
  return (
    <div className='mainblock'>
      <div className='main'>
        ...
        <div className="main3mobile">P2PAudit helps Web3 projects meet <span className="pink2"> world leading independent security experts </span></div>
        <div className='coinmobile'>
          <img src={coin} alt="coin" className='coinimagemobile' />
        </div>
        <div className="main2mobile">Empowering your decentralized dreams with expert<br /> audits and Web3 Security.</div>
        <div className="main4">
